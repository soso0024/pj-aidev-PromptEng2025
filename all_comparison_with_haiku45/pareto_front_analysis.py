#!/usr/bin/env python3
"""
Pareto Front Analysis: Cost vs Effective Coverage (with Claude 4.5 Haiku)
...
class ParetoFrontAnalysis:
    ...
    def __init__(self, base_dir: str = None):
        ...
        # Focused on main models for better visualization
    ...
    def create_pareto_front_plot_all(self, output_dir: Path = None) -> None:
        ...
        # Place Models legend to the left of Configurations legend using bbox_to_anchor
        legend1 = ax.legend(
            handles=model_legend_elements,
            loc="lower right",
            bbox_to_anchor=(0.62, 0.0),  # Adjust x position to move right
            title="Models",
            fontsize=18,
            title_fontsize=20,
            framealpha=0.9,
        ...
        ax.legend(
            ...
            loc="lower right",
            bbox_to_anchor=(1.0, 0.0),  # Keep at the right edge
...
def main():
    ...
    print("🔍 Pareto Front Analysis: Cost vs Effective Coverage (with Claude 4.5 Haiku)")
    print("=" * 70)
