...
This directory contains comprehensive tests for the `test_case_generator.py` module, which generates pytest-compatible test cases for HumanEval problems using Claude API.

## 📁 Files

- `test_test_case_generator.py` - Complete test suite with 52 tests
...
```bash
pytest tests/test_test_case_generator.py::TestTestCaseGeneratorInitialization -v
pytest tests/test_test_case_generator.py::TestDatasetOperations -v
pytest tests/test_test_case_generator.py::TestPromptGeneration -v
pytest tests/test_test_case_generator.py::TestCodeCleaning -v
pytest tests/test_test_case_generator.py::TestAPIIntegrationAndCosts -v
pytest tests/test_test_case_generator.py::TestFileOperations -v
pytest tests/test_test_case_generator.py::TestPytestEvaluation -v
pytest tests/test_test_case_generator.py::TestErrorHandlingAndEdgeCases -v
```

**Run specific test:**
```bash
pytest tests/test_test_case_generator.py::TestTestCaseGeneratorInitialization::test_init_with_default_config -v
```
...
tests/test_test_case_generator.py::TestTestCaseGeneratorInitialization::test_init_with_default_config PASSED [  1%]
tests/test_test_case_generator.py::TestTestCaseGeneratorInitialization::test_init_with_custom_models PASSED [  3%]
tests/test_test_case_generator.py::TestTestCaseGeneratorInitialization::test_init_with_invalid_model PASSED [  5%]
...
tests/test_test_case_generator.py::TestErrorHandlingAndEdgeCases::test_print_model_summary PASSED [100%]
